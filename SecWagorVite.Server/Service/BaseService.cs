...
namespace SecWagorVite.Server.Controllers.Service
{
    public class BaseService<T> : IDisposable where T : class
    {
        ...
        private SecDbContext dbContext;

        /// <summary>
        /// BaseService 建構子
        /// </summary>
        /// <param name="dbModel"></param>
        public BaseService(SecDbContext dbModel)
        {
        ...
        //public BaseService(SecDbContext dbContext)
        //{
